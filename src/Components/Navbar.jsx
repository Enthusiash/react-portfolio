...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      ...
      <ul ref={navbarRef} className={isMenuOpen ? 'nav-links-mobile' : 'nav-links'}>

        <a onClick={isMenuOpen ? toggleMenu : ''} href="#home" className="home">
          <li>Home</li>
        </a>

        <a onClick={isMenuOpen ? toggleMenu : ''} href="#experience-section" className="experience">
          <li>Experiences</li>

        </a>
        <a onClick={isMenuOpen ? toggleMenu : ''} href="#about-section" className="about">
          <li>About</li>
        </a>
